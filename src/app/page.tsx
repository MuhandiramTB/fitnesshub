...
export default function Home() {
  ...
  const handleLoginSuccessAction = (user: UserData) => {
    setUserData(user);
    setIsRegisterModalOpen(false);
    // Clear the email input after successful login/registration
    setEmail('');
  };
  ...
  return (
    <main className="relative flex size-full min-h-screen flex-col bg-[#111714] dark group/design-root overflow-x-hidden">
        ...
        <div className="px-4 sm:px-6 md:px-8 lg:px-40 flex flex-1 justify-center py-5 mt-4">
          <div className="layout-content-container flex flex-col w-full max-w-[960px] flex-1">
            ...
            <div className="@container">
              <section className="flex flex-col justify-end gap-4 sm:gap-6 px-4 py-8 sm:py-10 @[480px]:gap-8 @[480px]:px-10 @[480px]:py-20">
                ...
                <div className="flex flex-1 justify-center w-full">
                  <form onSubmit={handleEmailSubmit} className="flex flex-col w-full min-w-[280px] sm:min-w-40 h-14 max-w-[480px] flex-1 @[480px]:h-16">
                    <div className="flex w-full flex-1 items-stretch rounded-xl h-full">
                      ...
                      <div className="flex items-center justify-center rounded-r-xl border-l-0 border-none bg-[#29382f] pr-2">
                        <button
                          type="submit"
                          aria-label="Join Now"
                          className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-4 @[480px]:h-12 @[480px]:px-5 bg-[#38e07b] text-[#111714] text-sm font-bold leading-normal tracking-[0.015em] @[480px]:text-base @[480px]:font-bold @[480px]:leading-normal @[480px]:tracking-[0.015em] hover:bg-[#2fc66a] transition-colors"
                        >
